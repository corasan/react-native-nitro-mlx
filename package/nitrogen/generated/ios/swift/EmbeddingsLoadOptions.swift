...
/**
 * Represents an instance of `EmbeddingsLoadOptions`, backed by a C++ struct.
 */
public typealias EmbeddingsLoadOptions = margelo.nitro.mlxreactnative.EmbeddingsLoadOptions

public extension EmbeddingsLoadOptions {
  private typealias bridge = margelo.nitro.mlxreactnative.bridge.swift

  /**
   * Create a new instance of `EmbeddingsLoadOptions`.
   */
