...
open class HybridModelManagerSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridModelManagerSpec_cxx) -> Bool {
  ...
  @inline(__always)
  public final func getDownloadManifest(modelId: std.string) -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.getDownloadManifest(modelId: String(modelId))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__string__ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__string__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__string__(__promise)
        __result
